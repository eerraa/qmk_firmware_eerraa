...
Non-split RP2040 firmware for the NEWONE ODESSEY60H.

* Keyboard Maintainer: eerraa
* Hardware Supported: ODESSEY60H PCB
* Hardware Availability: Not available

Make example for this keyboard after setting up your build environment:

    make era/newone/odessey60h:default

Flashing example for this keyboard:

    make era/newone/odessey60h:default:flash
