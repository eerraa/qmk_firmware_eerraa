...
The inter-half USB-C connector is not a USB data port. On affected Tomak PCBs,
the D+/RX line is used as a single-wire half-duplex serial line and the D-/TX
line is left as an input by firmware. This avoids driving the GP0/TX line
