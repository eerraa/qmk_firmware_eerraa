...
/* Test fixture requested for repeated device captures. Keep both physical
 * F6/F7 positions on the passive wire snapshot until the user explicitly
 * requests restoration. */
_Static_assert(WIRE_DIAG == 0x7E08, "TOMAK capture keys must emit diagnostic keycode 0x7E08.");

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {

    [0] = LAYOUT_all(
        KC_ESC,             KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    WIRE_DIAG, WIRE_DIAG, KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,             KC_F13,   KC_PSCR,  KC_SCRL,  KC_PAUS,
