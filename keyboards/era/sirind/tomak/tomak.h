...
/* What a keymap reaches through QMK_KEYBOARD_H, and this board owns none of
   ...
   This is the board the eight `IN_*` indicator keycodes belonged to. They are
   gone, the indicator is configured through VIA like its siblings', and the
   three diagnostics keycodes moved down to the slots the family uses; that
   header states what it cost. */
