...
| `keyboards/era/sirind/common/tomak_common.[ch]`, `keyboards/era/sirind/common/tomak_era_keyboard_config.h` | tomak family board content for `tomak`, `tomak79h`, and `tomak79s`, including the syncable RGB idle-timeout storage/migration. The header preamble is the family boundary. None of the three boards keeps a `.c` |
