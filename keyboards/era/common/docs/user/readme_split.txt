...
최소화했습니다. 그 밖에 TAPDANCE, SOCD, Anti-Ghosting(꾹보드),
...
cable is connected or not. It also adds TAPDANCE, SOCD, Anti-Ghosting
(held-key refresh), DEBOUNCE, TAPPING, MOUSE, NKRO, plus split-only dual-host
