...
so these paths are the five roots `era_doc_refs.py` and the pre-commit check use and
...
`manuals/era_qmk_fork_ledger.md` in the same change — the pre-commit check enforces
