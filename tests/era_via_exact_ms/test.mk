...
# Host proof of exact-ms VIA get/set and GET_KEYBOARD_VALUE 0x06 against the
# shipped ERA tapping / tap-dance and State Sync units. Production ERA NVM/QMK
# integration is covered by tests/era_nvm_qmk_driver.
